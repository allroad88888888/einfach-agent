# @einfach-agent/persistence-sqlite

A SQLite session and history persistence driver for the `@einfach-agent/core` persistence contract.
...
`@einfach-agent/core/state/persistence`. The Tauri desktop host injects the desktop SQL plugin;
