...
|---|---|---|---|---|---|
| 001 | 归档恢复保留完整子 Agent 结果 | gpt-5.6-terra | running | 2026-09-03 | |
| 002 | CLI 与宿主执行同一模型凭据和端点安全规则 | gpt-5.6-terra | done | 2026-09-03 | 2026-09-03 |
| 003 | 三种运行表面消费同一 provider transport policy | gpt-5.6-sol | pending | 2026-09-03 | |
| 004 | 所有归档 CLI 使用同一安全路径映射 | gpt-5.6-terra | running | 2026-09-03 | |
