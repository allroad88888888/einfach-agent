...
export function AskUserQuestionCard() {
  ...
  const payload = normalizeAskUserQuestionPayload(run.pendingQuestion)
  ...
  return (
    <section className="agentnew-ask" aria-labelledby="agentnew-ask-title">
      <header className="agentnew-ask-header">
        <span className="agentnew-ask-eyebrow">运行已暂停</span>
