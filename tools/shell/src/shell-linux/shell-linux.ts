// tools/shell-linux/shell-linux.ts —— Linux shell 工具。副作用只经 ctx.runShell。
...
export const shellLinuxTool: Tool = {
  ...
  async execute(args, ctx) {
    ...
    if (fileWrite) {
      return shellFileWriteRejected('shell_linux', fileWrite)
    }
